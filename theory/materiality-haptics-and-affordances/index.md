...
layout: blog
images:
  - image: Figure 1&colon; Associations of materials in interaction design e.g. wood, metal, ceramic, glass by Magnific
    url: assoziations.png
    space-above: 22
    space-below: 1
  - image: Figure 2&colon; Easy Assembly children’s chair concept demonstrating material considerations in design by Alesina et al. (2010)
    url: kids-furniture.png
    space-above: 24
    space-below: 1
  - image: Figure 3&colon; AI-generated materials and digital materiality using prompts by Becerra (2026)
    url: ai-materials.png
    space-above: 18
  - image: Figure 4&colon; Exploration of material properties such as softness and density with cotton and felt by Becerra (2026)
    url: cotton-felt.png
    space-above: 2
    space-below: 1
  - image: Figure 5&colon; Surreal material transformation of a fork losing its functional affordance by Becerra (2026)
    url: fork.png
    space-above: 2
    space-below: 1
  - image: Figure 6&colon; AI-generated shoe design demonstrating physically complex material structures by Becerra (2026)
    url: shoes.png
    space-above: 2
    space-below: 1
  - image: Figure 7&colon; Misfit Ray wearable as an example of material-centered interaction design by Wilberg (2018)
    url: misfit-ray.png
    space-above: 13
    space-below: 1
  - image: Figure 8&colon; inFORM dynamic shape display translating digital data into physical form by Leithinger (2013)
    url: inform-dynamic-shape-display.png
    space-above: 2
    space-below: 1
  - image: "Figure 9: Recommended Reading - Exploring Materials: Creative Design for Everyday Objects by Alesina et al. (2010)" 
